...
-- to list files in table stage
list @%CUSTOMER_TABLE;


PUT FILE://D:\Senthamil\Learning\Snowflake SnowPro Core Certification\Udemy Resources\Code+and+Data+Files\data\MOCK.csv @%/CUSTOMERS_TABLE/STAGED AUTO_COMPRESS = FALSE;
